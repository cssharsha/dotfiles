...
# Create a black background and composite the icon in the center
magick -size "$RESOLUTION" xc:black \
    "$ICON" -gravity center -composite "$TMP_IMG"

# Lock the screen with i3lock, using the new centered image
i3lock -i "$TMP_IMG" \
    --color=00000000 \
    -f -k \
    \
